  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col items-center justify-center p-6">
      ...
      <div className="w-full max-w-md bg-white border border-slate-100 rounded-3xl shadow-xl p-8">
        ...
        <p className="text-slate-500 text-sm mb-8">Join 1,000+ businesses finding grants with AI.</p>
        ...
        <form onSubmit={handleRegister} className="space-y-5">
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="w-full py-4 bg-slate-900 text-white font-bold rounded-2xl hover:bg-slate-800 transition-all shadow-lg shadow-slate-100 flex items-center justify-center disabled:bg-slate-300"
          >
